...
START TRANSACTION;
USE `universidad`;
INSERT INTO `universidad`.`Curso` (`id`, `codigo`, `nombre`, `creditos`, `horas_semanales`, `nivel`, `Carrera_id`) VALUES (1, 'EIF-200', 'Funda', 10, 5, '1ero', 1);
...
INSERT INTO `universidad`.`Usuario` (`idUsuario`, `clave`, `tipo`) VALUES ('profesor2', 'profesor2', 3);
INSERT INTO `universidad`.`Usuario` (`idUsuario`, `clave`, `tipo`) VALUES ('profesor3', 'profesor3', 3);
INSERT INTO `universidad`.`Usuario` (`idUsuario`, `clave`, `tipo`) VALUES ('estudiante2', 'estudiante2', 4);
INSERT INTO `universidad`.`Usuario` (`idUsuario`, `clave`, `tipo`) VALUES ('estudiante3', 'estudiante3', 4);
INSERT INTO `universidad`.`Usuario` (`idUsuario`, `clave`, `tipo`) VALUES ('matriculador2', 'matriculador2', 2);
INSERT INTO `universidad`.`Usuario` (`idUsuario`, `clave`, `tipo`) VALUES ('matriculador3', 'matriculador3', 2);
INSERT INTO `universidad`.`Usuario` (`idUsuario`, `clave`, `tipo`) VALUES ('admin2', 'admin2', 1);
INSERT INTO `universidad`.`Usuario` (`idUsuario`, `clave`, `tipo`) VALUES ('admin3', 'admin3', 1);
...
INSERT INTO `universidad`.`Profesor` (`cedula`, `nombre`, `telefono`, `email`, `Usuario_id`) VALUES ('1112', 'Steven', '8643213', 'st.g.c', 'profesor2');
INSERT INTO `universidad`.`Profesor` (`cedula`, `nombre`, `telefono`, `email`, `Usuario_id`) VALUES ('1113', 'Camaño', '647382', 'camañin@g.c', 'profesor3');
...
START TRANSACTION;
USE `universidad`;
INSERT INTO `universidad`.`Grupo` (`id`, `numero`, `Horario_id`, `Curso_id`, `Profesor_cedula`, `Ciclo_anio`, `Ciclo_numero`) VALUES (1, 5, 1, 1, '111', 2016, 1);
...
INSERT INTO `universidad`.`Estudiante` (`cedula`, `nombre`, `telefono`, `email`, `fechaNac`, `Usuario_id`, `Carrera_id`) VALUES ('223', 'Pedro', '43423443', 'p@f.c', '1900-05-05', 'estudiante2', 1);
INSERT INTO `universidad`.`Estudiante` (`cedula`, `nombre`, `telefono`, `email`, `fechaNac`, `Usuario_id`, `Carrera_id`) VALUES ('224', 'Jaimito', '34242344', 'o.c', '1960-04-04', 'estudiante3', 2);
...
START TRANSACTION;
USE `universidad`;
INSERT INTO `universidad`.`Matriculador` (`cedula`, `nombre`, `telefono`, `email`, `Usuario_id`) VALUES ('33345', 'Jaime', '88667788', 'j@c.d', 'matriculador');
INSERT INTO `universidad`.`Matriculador` (`cedula`, `nombre`, `telefono`, `email`, `Usuario_id`) VALUES ('33346', 'Navas', '52543242', 'nava@jilla.com', 'matriculador2');
INSERT INTO `universidad`.`Matriculador` (`cedula`, `nombre`, `telefono`, `email`, `Usuario_id`) VALUES ('33347', 'Centeno', '23423424', 'pate@cintazul.c', 'matriculador3');
...
START TRANSACTION;
USE `universidad`;
INSERT INTO `universidad`.`Administrador` (`cedula`, `nombre`, `telefono`, `email`, `Usuario_id`) VALUES ('9999', 'Jhonny Araña', '666-999', 'johnypalpueblo@figueres.cr', 'admin');
INSERT INTO `universidad`.`Administrador` (`cedula`, `nombre`, `telefono`, `email`, `Usuario_id`) VALUES ('9998', 'Abel Pacheco', '999-666', 'muchasgracias@pacheco.c', 'admin2');
INSERT INTO `universidad`.`Administrador` (`cedula`, `nombre`, `telefono`, `email`, `Usuario_id`) VALUES ('9997', 'Laura', '696-969', 'lauritaSi@g.c', 'admin3');
