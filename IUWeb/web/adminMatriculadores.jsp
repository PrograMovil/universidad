...
<html>
    <head>
        ...
        <title>Matriculadores</title>
        <%@ include file="imports.jspf" %> 
        <meta name="viewport" content="width=device-width, initial-scale=1.0"/> 
    </head>
    <body>
        <%@ include file="header.jspf" %>
        <%ArrayList<Matriculador> matriculadores = (ArrayList<Matriculador>) session.getAttribute("matriculadores"); %>
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10" >
                            <form action="Servlet" method="POST" class="form-inline">
                                ...
                                <button type="submit" class="btn btn-default" name="action" value="BuscarMatriculador">Buscar Matriculador</button>
                            </form>
                        </div>
                        <div class="col-md-2" >
                            <a href="#agregarModal" data-toggle="modal" class="btn btn-primary pull-right" >Agregar Matriculador</a>
                        </div>                                               
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table" style="text-align: center">
                                ...
                                <% for( Matriculador ma : matriculadores ){ %>
                                <tr>
                                    <td><%= ma.getCedula() %></td>
                                    <td><%= ma.getNombre() %></td>
                ...
                <div class="modal-content">
                    <form action="Servlet">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-default" name="action" value="EditarMatriculador">Editar Matriculador</button>
                        </div>
                    </form>                    
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="Servlet" method="POST">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-danger" data-dismiss="modal">Cancelar</a>
                            <button type="submit" class="btn btn-default" name="action" value="AgregarMatriculador">Agregar Matriculador</button>
                        </div>
                    </form>                    
                </div>
            </div>
